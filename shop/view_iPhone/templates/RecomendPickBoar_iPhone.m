...
@implementation RecomendPickBoar_iPhone
...
- (void)load
{
    ...
    self.recommendUsersModel = [[[RecommendUsersModel alloc] init] autorelease];
    [self.recommendUsersModel addObserver:self];
}

- (void)unload
{
    [self.recommendUsersModel removeObserver:self];
    self.recommendUsersModel = nil;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( region )
    {
        ...
        self.recommendUsersModel.parent_id = region.id;
        [self.recommendUsersModel fetchFromServer];
    }
}
